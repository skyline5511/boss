(function(w,d,u){
    ...
    var page = {
        ...
        publish: function () {
            ...
            var vsummary = $('input[name="summary"]').val();
            var vdetail = $("#detail").val();
            var vpic = $("#imgpre")[0].src;
            var vprice = $('input[name="price"]').val();
            $.ajax({
                data: {"title":vtitle, "summary":vsummary, "detail":vdetail, "pic":vpic, "price":vprice},
                type: 'POST',
                url: '/seller/publish',
                success: function (result) {
                    var content = {"title":vtitle, "summary":vsummary, "detail":vdetail, "pic":vpic, "price":vprice};
                    var name = 'publish';
                    util.setCookie(name, content);
                    location.href = "publicSubmit.html";
                }
            });
        }
    };
...
//        var pic = $("#imgpre")[0].src;
//        var price = $('input[name="price"]').val();
//        $.ajax({
//            data: {"title":title, "summary":summary, "detail":detail, "pic":pic, "price":price},
//            type: 'POST',
//            url: '/seller/publish',
//            success: function (result) {
//                location.href = "publicSubmit.html";
